...
export interface RequestLetterData {
  /**
   * Contract note for letterNumber:
   * The master template already includes the static prefix "ที่ อว ๐๖๒๔.๖/"
   * Currently, input letterNumber is drawn after the slash (e.g. "ว ๑๒๓/๒๕๖๙").
   * Phase 1 must confirm with user whether staff input is strictly the suffix
   * (e.g. "ว ๑๒๓/๒๕๖๙") or a full official letter number string.
   */
  letterNumber: string
  issueDate: Date
  term: number
