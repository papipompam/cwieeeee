  ...
  <div class="space-y-4">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
      <div>
        ...
        <p class="text-xs text-muted mt-0.5">วางแผนและติดตามกำหนดการออกตรวจนิเทศสหกิจศึกษา</p>
      </div>
      ...
      <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-default text-sm text-left">
          <thead class="bg-muted/30 text-xs font-semibold text-muted uppercase tracking-wider">
            <tr>
              <th scope="col" class="px-4 py-3">วันและเวลา</th>
              ...
              <th scope="col" class="px-4 py-3">รูปแบบ</th>
          ...
          <tbody class="divide-y divide-default">
            <tr>
              <td colspan="7" class="py-12 text-center text-muted">
                ...
                <p class="font-medium text-highlighted">ยังไม่มีข้อมูลตารางนิเทศในรอบนี้</p>
