  ...
  <div class="space-y-4">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
      <div>
        ...
        <p class="text-xs text-muted mt-0.5">ติดตามแบบประเมินผลการฝึกงานจากนักศึกษาและสถานประกอบการ</p>
      </div>
      ...
      <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-default text-sm text-left">
          <thead class="bg-muted/30 text-xs font-semibold text-muted uppercase tracking-wider">
            <tr>
              <th scope="col" class="px-4 py-3">ผู้ถูกประเมิน</th>
              <th scope="col" class="px-4 py-3">แบบประเมิน</th>
              <th scope="col" class="px-4 py-3">ผู้ประเมิน</th>
              <th scope="col" class="px-4 py-3">กำหนดส่ง</th>
              <th scope="col" class="px-4 py-3">วันที่ส่ง</th>
